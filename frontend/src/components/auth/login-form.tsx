...
export function LoginForm({ form, onChange, onLogin, disabled, oauth, error: parentError }: LoginFormProps) {
  ...
  return (
    <AuthLayout title="Welcome back" subtitle="Sign in to your TimeCapsule account">
      <div className="flex flex-col gap-6">
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <button onClick={() => navigate('/register')} className="font-medium text-accent underline-offset-4 hover:underline bg-transparent border-none p-0 shadow-none cursor-pointer">
            Create account
          </button>
        </p>
      </div>
