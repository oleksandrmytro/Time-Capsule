...
export function RegisterForm({ form, onChange, onSignup, onGoHome, onGoLogin, disabled, oauth, error: parentError }) {
  ...
  return (
    <AuthLayout title="Create your account" subtitle="Start preserving your memories today" onHome={onGoHome}>
