...
export function CapsulesList({ capsules, isLoading, onSelect, onCreate, onBack }) {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 lg:px-8">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <Button variant="ghost" size="sm" onClick={onBack} className="mb-2 gap-1.5 text-muted-foreground -ml-3"><ArrowLeft className="h-4 w-4" /> Home</Button>
