...
/**
 * Full user-facing update payload for capsule editing.
 * Owner/admin can update only fields explicitly present in this DTO.
 */
public class UpdateCapsuleRequest {
    ...
    @NotNull(message = "allowReactions is required")
